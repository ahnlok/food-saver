...
●Possible functions to trigger:<br>
    1. Send alert when an item is about to expire (24 hours? User set?)<br>
    2. Connect to API for item’s nutritional data<br>
    3. Connect to API for recipe suggestions based on items in fridge, with notifications to user of missing items based on recipe suggestions<br>

### 60 Second Elevator Pitch<br>
