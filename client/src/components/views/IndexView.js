              ...
              <div className="af-class-navigation-container">
                ...
                <div className="af-class-navigation-right">
                  ...
                  <nav role="navigation" className="af-class-nav-menu w-nav-menu">
                    ...
                    <a href="/Login" target="_blank" className="af-class-nav-link w-button">Login </a>
                    <a href="/Signup" target="_blank" className="af-class-nav-link w-button">Sign Up</a>
            ...
            <div id="Header" className="af-class-colour">
              <div className="af-class-container-flex">
                <div className="af-class-hero-content">
                  ...
                  <a href="./ Signup" className="af-class-button w-button">Create a Item</a>
                </div>
                  ...
                  <div className="af-class-columns w-row">
                    <div className="w-col w-col-6">
                      ...
                      <div className="af-class-footer-column">
                        <a href="IndexView" aria-current="page" className="af-class-footer-link w--current">Home</a>
